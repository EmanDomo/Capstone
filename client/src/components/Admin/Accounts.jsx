...
const Accounts = () => {
  ...
  const handleDelete = async (id, type) => {
    try {
      if (type === 'admin') {
        await axios.delete(`${host}/api/admins/${id}`);
      } else if (type === 'user') {
        await axios.delete(`${host}/api/users/${id}`);
      } else if (type === 'superadmin') {
        await axios.delete(`${host}/api/superadmins/${id}`);
      }
      fetchAccounts();
    } catch (error) {
  ...
  const handleSave = async () => {
    try {
      let url = `${host}/edit-accounts/${accountType}/${editAccount.id || editAccount.superadminid || editAccount.userId}`;
